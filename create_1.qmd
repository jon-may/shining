...
This object reacts to any change in input$file by reading the contents. The other objects in **server** can access it as **data()**, so the full **server** code can now be:
